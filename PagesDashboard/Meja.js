                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        <label for="meja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">meja</label>
                                        <input type="text" name="meja" id="meja" value={this.state.meja} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan number of meja" required />
                                    </div>
